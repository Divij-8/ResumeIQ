      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Powered by Gemini AI · Results ready</p>
          </div>
          <button
            onClick={onReset}
        ...
        {aiAnalysis && (
          <div className="rounded-2xl overflow-hidden border border-violet-500/30 shadow-2xl shadow-violet-900/20">
            {/* Header bar */}
            <div className="bg-gradient-to-r from-violet-600/80 to-blue-600/80 backdrop-blur-sm px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-white">AI Review</h2>
                  <p className="text-xs text-violet-200">Generated by Gemini · Full Report</p>
                </div>
              </div>
              <button
                onClick={() => setAiExpanded(!aiExpanded)}
                className="flex items-center gap-1.5 text-xs font-semibold text-violet-200 hover:text-white bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-lg transition-all duration-200"
              >
                {aiExpanded ? (
                  <>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Content */}
            <div className="bg-gradient-to-br from-[#1a1030] to-[#0d1428]">
              <div
                className={`px-6 py-5 transition-all duration-500 overflow-hidden ${aiExpanded ? '' : 'max-h-72'}`}
                style={aiExpanded ? {} : { WebkitMaskImage: 'linear-gradient(to bottom, black 60%, transparent 100%)' }}
              >
              ...
              {!aiExpanded && (
                <div className="px-6 pb-5 pt-2 flex justify-center">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-500 hover:to-blue-500 text-white text-sm font-semibold shadow-lg shadow-violet-900/40 transition-all duration-200 hover:scale-105 active:scale-95"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
